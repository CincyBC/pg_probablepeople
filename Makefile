...
DATA = sql/pg_probablepeople--0.0.1.sql include/generic_learned_settings.crfsuite include/person_learned_settings.crfsuite include/company_learned_settings.crfsuite
